...
const text = `주소:\n열 3일, 기침 5일.\n현병력:\n환자는 3일 전 특별한 유인 없이, 감기 후 얼굴 부종 발견, 발진 없음, 소변량 감소, 쇠약감 발생, 외래 치료로 호전 없어 본원에 내원.\n기왕력:\n당뇨병 10년, 고혈압 2년, 전염성 질환 1년. 기타 기왕 질환 보고.\n역학사:\n14일 내 확진환자, 의심환자, 무증상 감염자 및 그 밀접접촉자와의 접촉 부인; 14일 내 다음 장소 방문 부인: 수산, 육류 도매시장, 농수산물시장, 직전, 대형마트, 야시장; 14일 내 다음 장소 근무자와의 밀접접촉 부인: 수산, 육류 도매시장, 농수산물시장, 직전, 대형마트; 14일 내 주변(가정, 사무실) 2례 이상 집단성 발병 부인; 14일 내 발열 또는 호흡기 증상 있는 인원과의 접촉 부인; 14일 내 본인 발열 또는 호흡기 증상 부인; 14일 내 격리 관찰 대상자 및 기타 코로나-19와 관련될 수 있는 상황과의 접촉 부인; 동반 가족은 상기 상황 없음.\n체격검사:\nT: 39.5℃, P: 80bpm, R: 20회/분, BP: 120/80mmHg;\n보조검사:\n2020년 6월 10일, 단순방사: 적혈구용적비 36.50%(낮음) 40~50; 단핵세포 절대값 0.75*10/L(높음) 참고값: 0.1~0.6;\n외래진단: 처치치료: 전자서명: [　]\n기타기록:`
...
export const commentList: IComment[] = [
  {
    id: '1',
    content:
      '적혈구용적비(HCT)는 단위 체적당 적혈구가 전체 혈액 체적에서 차지하는 비율로, 적혈구와 혈장의 비율을 나타내는 데 사용됩니다.',
    userName: 'Hufe',
    rangeText: '적혈구용적비',
...
export const options: IEditorOption = {
  ...
  maskMargin: [60, 0, 30, 0] // 메뉴바 높이 60, 하단 도구모음 30을 마스크 레이어로
}
